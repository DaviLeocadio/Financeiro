      ...
      <div className="bg-white rounded shadow-sm p-3" id="table">
        ...
        <div className="mt-5">
          <p className="w-50 flex-wrap fs-5">
            ...
            desempenho da empresa ao longo do ano de 2024, abrangendo os
            principais indicadores financeiros, operacionais, estratégicos e de
            sustentabilidade. A intenção é fornecer transparência para
            stakeholders internos e externos e subsidiar a tomada de decisões.
          </p>
        </div>
