      ...
      <div className="modal-u rounded-3" id="modal-u">
        <div className="modal-dialog modal-dialog-centered">
          <div className="modal-content d-flex justify-content-center align-items-center">
            ...
            <div className="modal-body d-flex flex-column gap-3 justify-content-center text-white w-75 mt-4">
              <h3 className="fonte text-center">
                Vamos começar o seu planejamento financeiro
              </h3>
