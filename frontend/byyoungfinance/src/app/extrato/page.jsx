    ...
    return(<>
     <div className="d-flex flex-row gap-4 mt-4">
        ...
        <div className="div-entradas p-3">
            <button className="button-entradas bg-white p-2 rounded-pill d-flex gap-2"><i className="bi bi-chevron-down"></i>Entradas</button>
            <div className="entradas">
                <Grafico tipoGrafico="bar" labels="olaa" ></Grafico>
            </div>
        </div>
        <div className="entradas">
                <Grafico></Grafico>
