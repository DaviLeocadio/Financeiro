...
export default function HomePage() {
  ...
  const teamMembers = [
    { name: 'Jessica Anderson', image: '23.svg' },
    { name: 'Matthew Taylor', image: '24.svg' },
    { name: 'Amelia Morgan', image: '25.svg' },
    { name: 'Jessica Anderson', image: '26.svg' },
    { name: 'Matthew Taylor', image: '27.svg' },
  ];
