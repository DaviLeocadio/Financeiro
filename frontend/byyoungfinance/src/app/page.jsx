    ...
    <>
      ...
      <div className="text-white HomeInicial d-flex align-items-center justify-content-center text-center">
        <div className="container">
          <h1 className="mb-3 tituloInical">SISTEMA PARA CONTROLE</h1>
          <h1 className="mt-3 tituloInical">FINANCEIRO RÁPIDO E SEGURO</h1>
      ...
      <div className="imagemFundo d-flex m-0"></div>
      ...
      <div className="FundoHome">
        <div className="container my-5">
          <div className="row align-items-center">
            <div className="col-md-6 mb-1 mb-md-0 telaHome">
              <img
                src="/telaHome.jpg"
            ...
            <div className="col-md-6 text-center text-md-start">
              ...
              <p className="mb-4">Gerencie com precisão todas as despesas dos seus cartões de crédito. Tenha controle do cartão titular e dos adicionais. Receba lembretes para pagar suas faturas e contas em dia.</p>

              <div className="row mb-3 ">
                <div className="col-3 d-flex justify-content-end pe-1">
                  <img src="/1.jpg" className="img-fluid rounded" />
                </div>
                <div className="col-3 d-flex justify-content-start ps-1">
                  <img src="/2.jpg" className="img-fluid rounded" />
                </div>
              </div>
              <Link href="/cadastro">
               <button className=" botaoHome">EXPERIMENTAR ➜</button>
              </Link>
      ...
      <div className="Investir">
        <div className="container my-5 text-center">
          <div className="d-flex justify-content-center align-items-center mb-4">
            ...
            <h1 className="titulo me-2">PORQUE INVESTIR NA</h1>
            <h1 className="subtitulo">BY YOUNG FINANCE</h1>
          </div>
            ...
            <div className="p-3 ">
              <div className="row mb-3 justify-content-center">
                ...
                <div className="col-md-10 text-start">
                  <h4>FÁCIL DE USAR</h4>
                  <p className="pHome">Finalmente você vai sentir que domina a sua rotina financeira, e sem precisar de planilhas.</p>
                </div>
              </div>
              <div className="row mb-3 justify-content-center">
                <div className="col-md-2">
                ...
                <div className="col-md-10 text-start">
                  ...
                  <p className="pHome">Alcance o maior nível de eficiência da gestão financeira, com clareza em todos os fluxos.</p>
                </div>
              </div>
              <div className="row mb-3 justify-content-center">
                <div className="col-md-2">
                ...
                <div className="col-md-10 text-start">
                  ...
                  <p className="pHome">Acompanhe todas as contas de onde estiver, pelo site ou direto no nosso aplicativo.</p>
                </div>
              </div>
            </div>
            <div className="d-flex justify-content-center mt-2 gap-3">
              <Link href={'/funcionamento'}> <button className="botaoHome">USAR RECURSOS</button></Link>
             
              <Link href={'/sobrenos'}><button className="botaoHome2">CONHEÇA A GENTE</button></Link>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="celulartexto">
        <div className="imagemcelular">
          <img src="/celular.png" className="d-block " />
        </div>
        <div className="textoGuia">
          ...
          <div className="guiatexto justify-content-center align-items-center d-flex w-100">
            <div className="guia1 justify-content-center align-items-center d-grid w-100">
              <h2>01</h2>
      ...
      <div className="bancos">
        <div className="borda" >
          ...
          <div className="imgbancos" style={{ textAlign: "center", marginBottom: "40px" }}>
            <img src="/img/bancos.png" className="d-block w-100" alt="" style={{ width: "50%" }} />
          </div>
        </div>
      </div>
      <div className="recursos">
        ...
        <div className="flex">
          ...
          <div className="imagemcelularrecursos">
            <img src="/img/celular2.png" className="d-block w-100" alt="" style={{ width: "80%", borderRadius: "10px" }} />
          </div>
              ...
              <div id="carouselExample" className="carousel slide">
                <div className="carousel-inner">
                  <div className="carousel-item active">
                    <img src="/img/logosemfundo.png" className="d-block w-100" alt="..." style={{ width: "300px" }} />
                  </div>
                </div>
              </div>
            </div>
          </div>
          <div className="textoperguntas">
            <p>
      ...
      <div className="banner-container">
        <img src="/img/banner.png" alt="Banner YoungFinance" className="banner-img" style={{ width: "100%" }} />
        <Link href={'/cadastro'} className="btn-cadastrar">CADASTRE-SE</Link>
